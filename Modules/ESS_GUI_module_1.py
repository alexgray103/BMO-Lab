...
class Module_1:
    def __init__(self, master):
        ...
        self.graph_frame.grid(row = 1, column = 0,columnspan = 6, padx = 1, pady = 3, sticky = sticky_to)
        ...
        self.quit_button.grid(row = 0, column = 5, padx = 1, pady = 1, sticky = sticky_to)
        ...
        self.help_button.grid(row = 0, column = 4, padx = 1, pady = 1, sticky = sticky_to)
        ...
        self.settings_button.grid(row = 0, column = 3, padx = 1, pady = 1, sticky = sticky_to)
        
        self.save_reference_button = Button(self.root, text = "Save as Reference", wraplength = 80, fg = 'black', command = self.func.save_reference, width = button_width, height = button_big_height)
        self.save_reference_button.grid(row = 0, column = 2, padx = 1, pady = 1, sticky = sticky_to)
        ...
        self.acquire_button.grid(row = 0, column = 1, pady = 1, padx = 1, sticky = sticky_to)
        
        self.scan_button = Button(self.root, text = "Scan", fg = 'black', wraplength = 80, command = lambda: self.func.scan(save = True), width = button_width, height = button_big_height)
        self.scan_button.grid(row = 0, column = 0, padx = 1, pady = 1, sticky = sticky_to)
